...
class Managerweek_model extends Record_model {
    public function __construct() {
        parent::__construct('sManagerweek');
        $this->deleteCtrl = 'task';
        $this->deleteMethod = 'doDel/managerweek';
        $this->edit_link = 'task/edit/managerweek/';
        $this->short_info_link = $this->info_link = 'task/managerweekInfo/';

        $this->field_list['_id'] = $this->load->field('Field_mongoid',"id","_id");
        $this->field_list['name'] = $this->load->field('Field_string',"会议","name");

        $this->field_list['confTS'] = $this->load->field('Field_date',"会议日期","confTS");
        $this->field_list['confTS']->tips = '会议当天0点之前的将计入上周回顾';

        $this->field_list['beginTS'] = $this->load->field('Field_date',"内容囊括开始","beginTS");
        $this->field_list['beginTS']->tips = '一般选择会议时间的上周一';
        $this->field_list['endTS'] = $this->load->field('Field_date',"内容囊括结束","endTS");
        $this->field_list['endTS']->tips = '一般选择会议时间的本周末';

        $this->field_list['finalReport'] = $this->load->field('Field_text',"会议报表","finalReport");
    }
