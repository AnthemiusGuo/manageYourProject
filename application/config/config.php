...
$config['base_title'] = '项目管理';


$config['app_name'] = 'carApp';
//短信验证码时间限制
$config['mobile_code_expire'] = 180;	//手机验证码有效时间（秒）
$config['mobile_code_period'] = 60;	//手机重新获取验证码的间隔时间（秒）
$config['mobile_code_length'] = 6;            //手机验证码字符长度
$config['mobile_code_prefix'] =  'T_';             //手机验证码时间戳key前缀
$config['mobile_verifycode_pre'] = "M_";//验证码前缀
...
$config['sess_expiration']		= 2592000;//86400*30
